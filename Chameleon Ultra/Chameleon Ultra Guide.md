...
2. [Opstart](#2-opstart)
3. [Forbind til enheden](#3-forbind-til-enheden)
4. [Læs et HF-kort (MIFARE Classic)](#4-læs-et-hf-kort-mifare-classic)
5. [Læs et LF-tag (EM410X)](#5-læs-et-lf-tag-em410x)
6. [Gem data (dump)](#6-gem-data-dump)
7. [Skriv data til Chameleon (emulering)](#7-skriv-data-til-chameleon-emulering)
8. [Slot-styring](#8-slot-styring)
9. [Nyttige kommandoer](#9-nyttige-kommandoer)
